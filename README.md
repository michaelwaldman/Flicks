...
Added a custom ActionBar with custom coloring/size
## Video Walkthrough
...
The adding of the Youtube videos was the most difficult, as it required one to do it entirely without any code for reference - this was by far the most time consuming part.
